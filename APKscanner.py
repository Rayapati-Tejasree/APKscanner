...
from static_tools import owasp_extractor,andriod_manifest
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        #description="{BOLD}{GREEN}APKScanner:{ENDC} Android security insights. ".format(BOLD=util.BOLD, GREEN=util.OKCYAN, ENDC=util.ENDC),
...
if __name__ == "__main__":
    try:
        ...
        manifest_results = andriod_manifest.ScanAndroidManifest().extract_manifest_info(extracted_source_path)
        ...
        obj = owasp_extractor.SensitiveInfoExtractor()
